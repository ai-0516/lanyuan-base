...
from app.api.v1 import (
    ai, auth, comments, memory, notifications, parking_locations, parking_rentals,
    posts, profile, wechat_events,
)
...
app.include_router(parking_locations.router, prefix="/api/v1")
